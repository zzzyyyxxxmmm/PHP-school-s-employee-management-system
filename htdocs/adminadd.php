...
败".mysql_error());
				...
				*/
				...
				if ($_POST[Submit]=="插入"){
					...
					mysql_query("insert into user(User,Password) values('$id','$ps') ");
					if($s!="")
					{
					...
					else mysql_query("update user set Insert_priv='N' where User='$id' ");
					if($u!="")
					{
						mysql_query("update user set Update_priv='Y' where User='$id' ");
					}
					else mysql_query("update user set Update_priv='N' where User='$id' ");
					if($d!="")
					{
