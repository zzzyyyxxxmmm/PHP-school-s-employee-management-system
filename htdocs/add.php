...
败".mysql_error());
				...
				*/
				$na=$_SESSION['name'];
				$sq=mysql_query("select * from user where User='$na' AND  Insert_priv='Y'");
      ...
      <table width="550" align="center" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <!--  翻页条 -->
							...
							if($page!=1){
							/*  显示“首页”超链接  */
							echo  "<a href=add.php?page=1>首页</a>&nbsp;";
							/*  显示“上一页”超链接  */
							echo "<a href=add.php?page=".($page-1).">上一页</a>&nbsp;";
							}
							/*  如果当前页不是尾页  */
							if($page<$page_count){
							/*  显示“下一页”超链接  */
							echo "<a href=add.php?page=".($page+1).">下一页</a>&nbsp;";
							/*  显示“尾页”超链接  */
							echo  "<a href=add.php?page=".$page_count.">尾页</a>";
							}
							?>
                        </tr>
                      </table></td>
